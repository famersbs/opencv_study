...
Ext.define('Ext.app.view.PortalPanel', {
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('Ext.app.view.PortalDropZone', this, this.dropConfig);
    },
